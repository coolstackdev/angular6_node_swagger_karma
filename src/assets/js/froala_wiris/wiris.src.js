...
(function ($) {
    ...
    function createIntegrationModel(editor) {
        ...
        froalaIntegrationProperties.configurationService = 'https://pascalium.pp.ua/virtuprofs/froala/integration/configurationjs.php';
        froalaIntegrationProperties.version = '7.7.0.1395';
